...
?>
    <div class="filter-sec d-flex align-items-center">
        <div class="filter-btn d-flex">
            <button type="button" class="btn btn-secondary filter-button" data-postype='projektyinwestycyjne'><?php _e('Projekty inwestycyjne ', 'prow') ?></button>
            <button type="button" class="btn btn-primary filter-button"   data-postype='projekty_leader'><?php _e('Projekty leader', 'prow') ?> </button>
        </div>
    </div>
                        ...
                        <div class="article-content">
                            <div class="article-top">
                                ...
                                <div class="excerpt-sec">
                                    ...
                                    <p><span><?php echo $dofinansowania['label']; ?></span><?php 
