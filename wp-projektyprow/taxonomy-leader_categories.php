...
if ($is_first_level) {
    ...
    $message = sprintf(__('%s', 'prow'), esc_html($term->name));
} else {
    $message = sprintf(__('%s', 'prow'), esc_html($term->name));
}
                    ...
                    <div class="header-content">
                        <div class="bread-crumbs">
                            <ul>
                                ...
                                <li>Projekty dofinansowane w ramach działania LEADER</li>
                            </ul>
                        </div>
                        <div class="page-title d-flex">
                            <h1>Projekty dofinansowane w ramach działania LEADER</h1>
                        </div>
                    </div>
                </div>
                               ...
                               if ($term && !is_wp_error($term)) {
                                ...
                                if ($term_id == 37) {
                                    ...
                                    $result = $wpdb->get_row("
                                        ...
                                        WHERE p.post_type = 'projekty_leader'
                                ...
                                $result = $wpdb->get_row("
                                    ...
                                    AND p.post_type = 'projekty_leader'
                                    AND p.post_status = 'publish'
                                ...
                                <div class="map-bottom-content">
                                    <p><?php _e('Całkowita wartość projektów:', 'prow') ?> 
                                        <b><?php echo number_format($result->total_project_value, 2, ',', ' ') ?><?php _e(' zł', 'prow') ?></b></p>
                                        <p><?php _e('Całkowita wartość dofinansowania z EFRROW:', 'prow') ?> 
                                        <b><?php echo number_format($result->total_eafrd_funding, 2, ',', ' ') ?><?php _e(' zł', 'prow') ?></b></p>
                                        <p><?php _e('Na obszarze ', 'prow'); echo $message; _e(' zrealizowano', 'prow'); ?>  
                                        <b><?php echo number_format($result->total_posts); ?></b><?php _e(' projektów:', 'prow'); ?></p>
                                    ...
                                    <div class="map-projects-list">
                                        <ul class="disnone">
                                            ...
                                            INNER JOIN   
                                                {$wpdb->term_taxonomy} ptt ON ptr.term_taxonomy_id = ptt.term_taxonomy_id AND ptt.taxonomy = 'project-category'   
                                            INNER JOIN   
                                            ...
                                            GROUP BY   
                                                ...
                                                WHERE   
                                                    p.post_status = 'publish' AND   
                                                    p.post_type = 'projekty_leader' AND   
                                                    tt.taxonomy = 'leader_categories' AND   
                    ...
                    <div class="col-lg-4 d-none d-lg-block">
                        <div class="map-right-sec">
                            ...
                            foreach ($child_terms as $child_term) {
                                ...
                                if ($parent_term && $parent_term->parent != 0) {
                                    $is_first_level = false; // If parent has a parent, it's not first level
                                    break;
                                }
                            }
                            ...
                            if ($is_first_level) { ?>
                                <div class="web-heading">
                                    <h2><?php _e('Lokalne Grupy Działania', 'prow'); ?></h2>
                                </div>
                            <?php } else { ?>
                                <div class="web-heading">
                                ...
                                <div class="map-menu"> 
                                    <?php 
                                        ...
                                        foreach ($child_terms as $child) {
                                            ...
                                            $descendant_terms = get_term_children($child->term_id, 'leader_categories');
                                            ...
                                            $post_count = (int) wp_count_posts_in_term('projekty_leader', $all_terms, 'leader_categories');
                    ...
                    <table class="table data-table" id="project-table">
                        <thead>
                            <tr>
                                ...
                                <th class="bigdesktop middesktop lg-none"><?php _e('Lokalne Grupy Działania', 'prow') ?></th>
                                <th class="bigdesktop middesktop lg-none"><?php _e('Gmina', 'prow') ?></th>
                                <th class="bigdesktop middesktop"><?php _e('Poddziałanie', 'prow') ?></th>
                           ...
                           if ($term_query->have_posts()) {
                                while ($term_query->have_posts()) {
                                    $term_query->the_post(); 
                                        ...
                                        $poddzialanie = get_field('poddziałanie_text_with_icon', get_the_ID());
                                        $typoperacji = get_field('typ_operacji_text_with_icon', get_the_ID());
                                        $beneficjent = get_field('beneficjent_text_with_icon', get_the_ID());
                                        $powiat = get_field('lokalna grupa działania_text_with_icon', get_the_ID());
                                        ...
                                        // $poddzialanie = get_field('poddzialanie', get_the_ID());
                                  ...
                                  <tr class="<?php echo ($praktykios == 'Tak') ? 'secondary' : 'primary'; ?>">
                                        ...
                                        <td> <?php echo isset($poddzialanie['title']) ? $poddzialanie['title'] : ''; ?></td>
